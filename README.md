...
- Go to your Project Zomboid ```Server``` Folder 
          (the one with your StartServer64.bat) 
          
- Open ```Java``` Folder 
- unzip ```zombie.zip``` file in it 
- If you see the folder zombie unzipped, you have the mod installed, please reboot your server and enjoy.
